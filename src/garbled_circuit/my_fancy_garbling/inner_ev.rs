...
use crate::garbled_circuit::my_fancy_garbling::check_binary;
...
impl<C: AbstractChannel, Wire: WireLabel + ArithmeticWire> FancyArithmetic for Evaluator<C, Wire> {
    ...
    fn proj(&mut self, _x: &Wire, _q: u16, _: Option<Vec<u16>>) -> Result<Wire, EvaluatorError> {
        todo!()
    }
}
